    ...
    def scrape_to_files(self, output_dir: str = ".", debug: bool = False) -> None:
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                logger.info(
                    "Data successfully saved to frontend/public/foreign_ownership_data.json, data/ownership/foreign_ownership_data.json, and CSV file"
                )
...
if __name__ == "__main__":
    ...
    scraper.scrape_to_files(
        output_dir="data/ownership", debug=True
    )  # JSON will be saved to frontend/public/, CSV to data/ownership/
